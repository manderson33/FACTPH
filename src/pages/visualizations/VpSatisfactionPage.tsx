...
import { vpSatisfactionData, adminColors, type Admin } from "../../data/vpSatisfactionData";
...
const dataByAdmin: Record<Admin, typeof vpSatisfactionData> = {
  aquino: vpSatisfactionData.filter((d) => d.admin === "aquino"),
  duterte: vpSatisfactionData.filter((d) => d.admin === "duterte"),
  marcos: vpSatisfactionData.filter((d) => d.admin === "marcos"),
};
