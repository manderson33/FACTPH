...
import {
  presidentialApprovalData,
  adminColors,
  type Admin,
} from "../../data/presidentialApprovalData";
...
const dataByAdmin: Record<Admin, typeof presidentialApprovalData> = {
  aquino: presidentialApprovalData.filter((d) => d.admin === "aquino"),
  duterte: presidentialApprovalData.filter((d) => d.admin === "duterte"),
  marcos: presidentialApprovalData.filter((d) => d.admin === "marcos"),
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card overflow-x-auto mb-10">
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {presidentialApprovalData.map((row) => (
