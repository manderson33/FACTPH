...
import {
  presidentialSatisfactionData,
  adminColors,
  type Admin,
} from "../../data/presidentialSatisfactionData";
...
const dataByAdmin: Record<Admin, typeof presidentialSatisfactionData> = {
  aquino: presidentialSatisfactionData.filter((d) => d.admin === "aquino"),
  duterte: presidentialSatisfactionData.filter((d) => d.admin === "duterte"),
  marcos: presidentialSatisfactionData.filter((d) => d.admin === "marcos"),
};
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <ResponsiveContainer width="100%" height={380}>
            <LineChart margin={{ bottom: 12, right: 24, left: 4 }}>
              ...
              <XAxis
                ...
                stroke="#9FB3C8"
              />
              <YAxis stroke="#9FB3C8" tickFormatter={(v) => `${v > 0 ? "+" : ""}${v}`} />
        ...
        <div className="glass-card overflow-x-auto mb-10">
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              {presidentialSatisfactionData.map((row) => (
        ...
        <div className="space-y-4 mb-10">
          <div className="glass-card p-4">
            <div className="flex items-start justify-between gap-3">
              ...
              >
                Social Weather Stations — quarterly surveys
