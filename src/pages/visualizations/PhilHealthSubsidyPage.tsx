    ...
    <div className="dot-grid min-h-screen pt-28 px-4 pb-16">
      ...
      <div className="max-w-4xl mx-auto">
        <Link to="/explore/health" className="flex items-center gap-2 text-accent text-sm mb-6">
          <ArrowLeft size={16} />
          {t("common.backTo", { category: t("pages.philhealthSubsidy.eyebrow") })}
        </Link>

        <p className="text-accent text-xs uppercase tracking-widest mb-2">
          {t("pages.philhealthSubsidy.eyebrow")}
        </p>
        <h1 className="text-3xl md:text-4xl font-heading font-bold text-white mb-3">
          {t("pages.philhealthSubsidy.title")}
        </h1>
        <p className="text-muted mb-8 max-w-2xl">{t("pages.philhealthSubsidy.description")}</p>
            ...
            >
              ...
              <Tooltip
                ...
                formatter={(value) => [
                  ...
                  t("pages.philhealthSubsidy.tooltipLabel"),
                ]}
              />
        ...
        <p className="text-footnote text-xs mb-10">{t("pages.philhealthSubsidy.footnote")}</p>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-muted border-b border-grid">
              <tr>
                ...
                <th className="p-4">{t("pages.philhealthSubsidy.tableSubsidy")}</th>
                <th className="p-4">{t("common.administration")}</th>
                <th className="p-4">{t("pages.philhealthSubsidy.tableNote")}</th>
              </tr>
            </thead>
            <tbody>
              {philhealthSubsidyByYear.map((row) => (
                  ...
                  <td className="p-4">
                    ...
                    {row.confidence === "proposed" && (
                      <span className="ml-2 text-footnote text-xs">
                        {t("pages.philhealthSubsidy.proposedTag")}
                      </span>
                    )}
                  </td>
